...
uint64_t AllocMdlMemory(uint64_t size, uint64_t* mdlPtr)
{
	...
	if (!mdl) 
	{
		printf(xorstr_ ("[IO] Failed to allocate pages.\n"));
	...
	{
		printf(xorstr_ ("[IO] Failed to read count.\n"));
	...
	if (byteCount < size) 
	{
		printf(xorstr_ ("[IO] Failed to align memory.\n"));
	...
	{
		printf(xorstr_ ("[IO] Failed to lock pages.\n"));
	...
	if (!result) 
	{
		printf(xorstr_ ("[IO] Failed to set page protection.\n"));
...
bool VDM_MAP::MapKernelModule(std::vector<uint8_t> driverImage)
{
	...
	KernelData.ExAllocatePoolWithTag = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("ExAllocatePoolWithTag"));
	KernelData.ExFreePoolWithTag = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("ExFreePoolWithTag"));

	KernelData.PsLookupProcessByProcessId = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("PsLookupProcessByProcessId"));

	KernelData.KeStackAttachProcess = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("KeStackAttachProcess"));
	KernelData.KeUnstackDetachProcess = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("KeUnstackDetachProcess"));

	KernelData.ObfDereferenceObject = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("ObfDereferenceObject"));
	KernelData.IoGetCurrentProcess = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("IoGetCurrentProcess"));

	KernelData.PsGetProcessPeb = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("PsGetProcessPeb"));
	KernelData.RtlFindExportedRoutineByName = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("RtlFindExportedRoutineByName"));

	KernelData.MmGetSystemRoutineAddress = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("MmGetSystemRoutineAddress"));
	KernelData.MmGetVirtualForPhysical = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("MmGetVirtualForPhysical"));
	
	KernelData.MmIsAddressValid = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("MmIsAddressValid"));
	KernelData.MmCopyVirtualMemory = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("MmCopyVirtualMemory"));

	KernelData.ZwQuerySystemInformation = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("ZwQuerySystemInformation"));
	KernelData.ZwAllocateVirtualMemory = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("ZwAllocateVirtualMemory"));
	KernelData.ZwProtectVirtualMemory = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("ZwProtectVirtualMemory"));
	KernelData.ZwQueryVirtualMemory = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("ZwQueryVirtualMemory"));
	KernelData.ZwFreeVirtualMemory = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("ZwFreeVirtualMemory"));

	KernelData.IoAllocateMdl = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("IoAllocateMdl"));
	KernelData.IoFreeMdl = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("IoFreeMdl"));

	KernelData.MmMapLockedPagesSpecifyCache = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("MmMapLockedPagesSpecifyCache"));
	KernelData.MmProtectMdlSystemAddress = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("MmProtectMdlSystemAddress"));
	KernelData.MmProbeAndLockPages = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("MmProbeAndLockPages"));
	KernelData.MmUnmapLockedPages = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("MmUnmapLockedPages"));
	KernelData.MmUnlockPages = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("MmUnlockPages"));

	KernelData.MmAllocateContiguousMemorySpecifyCache = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("MmAllocateContiguousMemorySpecifyCache"));
	KernelData.MmBuildMdlForNonPagedPool = VDM::GetKernelProcAddress(VDM::g_KernelBase, xorstr_ ("MmBuildMdlForNonPagedPool"));
	...
	do
	{
		...
		{
			printf(xorstr_ ("\n[IO] Failed to map vdm. Status: 0x%p\n"), status);
